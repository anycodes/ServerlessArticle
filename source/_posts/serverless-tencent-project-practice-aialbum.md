---
title: 基于Serverless Framework的人工智能小程序开发
date: 2020.4.29
tags: [Serverless, 腾讯云, 基本介绍, 小程序, 人工智能, 相册]
...
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-1.png)

该项目设计主要拥有登录功能、相册新建、图片上传以及相关预览功能，以及搜索功能，整体如图所示。

![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-2.png)
...
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-3.png)
...
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-4.png)

#### 图片功能：
图片功能主要包括图片列表以及图片获取、图片删除以及图片上传功能，在图片获取与删除的过程中，要对用户是否有该项操作的权限进行判断，图片上传时也要判断用户是否有上传到指定相册的权限。图片功能相关原型图如所示。

![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-5.png)

图片功能部分除了用户侧可见的功能，还有定时任务，当用户上传图片之后，系统会在后台异步进行图像压缩以及图像的描述，关键词提取等。整体流程如图所示。

![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-6.png)

#### 搜索功能：
搜索功能指的是通过关键词或者使用者的描述，可以获得到目标数据的过程，这一功能原型图如图所示。

![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-7.png)

这一部分的难点和重点在于通过用户的描述，搜索到目标数据的过程。这个过程的基本流程如图所示。

![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-8.png)
...
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-13.png)
...
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-9.png)
...
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-10.png)

 是的，这样我们就可以很简单轻松加愉快的将我们的公共组件库，在部署函数的时候，引入到项目中。
 
 本地形式：

![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-11.png)

 线上形式：
 
 ![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-6-12.png)
