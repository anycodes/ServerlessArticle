---
title: Serverless Blog开发（原生Serverless与Flask框架结合）
date: 2020.4.20
tags: [Serverless, 腾讯云, 基本介绍, Blog, 博客开发]
...
由于是做一个简单的博客，所以数据库相对设计比较简单，只有文章表、分类表以及标签表、评论表等，整体的ER图如下所示：

![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-5-6.png)
...
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-5-7.png)
...
* 列表页
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-5-1.png)

* 内容页
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-5-2.png)


### 后台功能

* 登录功能
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-5-3.png)

* 列表页
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-5-4.png)

* 表单页
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/3-5-5.png)
