---
title: Serverless实现视频压缩与格式转换
date: 2019.12.28
tags: [Serverless, 腾讯云, 基本介绍, Serverless Framework, 视频压缩, 格式转换, 音视频处理]
categories: [Serverless, 腾讯云, 领域实战]
---

## 前言

在Serverless架构的应用案例中，有这样一个非常实在的应用：视频的处理。
...
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/2-6-1.png)

在阿里云的函数计算也有相关的描述：

![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/2-6-2.png)
...
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/2-6-3.png)

也就是说，我们如果要在云函数中使用这个模块，那么我们就要有这样一个模块是在云函数所在的环境下可以运行起来的，根据云函数的文档可以看到：

![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/2-6-4.png)
...
![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/2-6-5.png)

稍等片刻，我们可以看到目标文件夹出现了对应的视频：

![](https://others-1304229895.cos.ap-shanghai.myqcloud.com/article/material/2-6-6.png)
